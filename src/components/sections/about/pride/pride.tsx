    ...
    <div className={styles.pride}>
      <div className={styles.pride_content}>
        ...
        <p className={styles.pride_description}>
          Результатами выпускников наших <br className={styles.br}/>образовательных проектов, целью которых <br className={styles.br}/>является создание инноваций и&nbsp;развитие <br className={styles.br}/>российской экономики
        </p>
      </div>
